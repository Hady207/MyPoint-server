...
import { CreateUserDTO, CreateAdminDTO, UserTokenDTO } from './dto';
...
export class UserService {
  ...
  async registerAdmin(admin: CreateAdminDTO): Promise<User> {
    return await this.userModel.create(admin);
  }
  ...
  async updateUserToken(id: string, token: UserTokenDTO): Promise<User> {
